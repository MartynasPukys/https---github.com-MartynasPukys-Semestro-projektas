...
namespace Scoreit.Migrations
{
    public partial class RestructuredDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("GameTeam");
            migrationBuilder.DropTable("PlayerTeam");
            migrationBuilder.DropTable("Team");
            migrationBuilder.CreateTable(
                name: "PlayerGames",
                columns: table => new
                {
                    PlayerGamesId = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerGames", x => x.PlayerGamesId);
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_User_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropTable("PlayerGames");
            migrationBuilder.CreateTable(
                name: "Team",
                columns: table => new
                {
